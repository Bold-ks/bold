...
export default async function ProductPage({ params }: Props) {
  ...
  const { images, specs, variants, badges, tagline_en, tagline_sq, show_starting_at, productId, hero } = await getProductImagesAndSpecs(slug);
  ...
  return (
    <ProductDetail
      ...
      showStartingAt={show_starting_at}
      story={story}
      hero={hero}
    />
  );
